...
var Picker = function Picker(_ref2) {
    ...
    var translate = (0, _reactAdmin.useTranslate)();

    var _useInput = (0, _reactAdmin.useInput)(_extends({
        format: format,
        onBlur: onBlur,
        onChange: onChange,
        onFocus: onFocus,
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(PickerComponent, _extends({
            id: id,
            label: _react2.default.createElement(_reactAdmin.FieldTitle, {
                label: label,
                source: source,
                resource: resource,
            ...
            margin: margin,
            error: !!(touched && error),
            helperText: _react2.default.createElement(_reactAdmin.InputHelperText, {
                touched: touched,
                error: error,
